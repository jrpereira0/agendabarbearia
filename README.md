...
| `N8N_APPOINTMENT_WEBHOOK_URL` | Avisa o barbeiro (webhook n8n) quando um agendamento é **criado**, **cancelado** ou **alterado** — ver [docs/API-N8N.md](docs/API-N8N.md#6b-webhook-aviso-automático-ao-barbeiro-appointmentcreated) |
